...
import * as exercises from './movies-model.mjs';
...
// GET exercises filtered by name or reps
app.get('/exercises', (req, res) => {
    let filter = {};
    // filter by year//by name
    if(req.query.name !== undefined){
        filter = { year: req.query.name };
    }
    // filter by language // reps
    if(req.query.reps !== undefined){
        filter = { language: req.query.reps };
    }
